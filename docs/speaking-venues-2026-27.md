# Speaking venues where selection is curated (no public voting)

Researched July 8, 2026. Every venue below is selected by organizers or
reviewer committees only — no community-vote stage. Ranked by fit ×
acceptance likelihood for a first-time nonprofit speaker × urgency.
Items marked UNVERIFIED need a check on the venue's own page before
acting (several sites block automated reading; deadlines were
...
- NTEN/NTC 2027 ("completely community led" voting)
- SXSW EDU PanelPicker (30% public vote — see
  docs/sxsw-edu-2027-submission.md for why it's still worth submitting:
  70% of the decision never sees vote counts)
