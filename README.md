...
- switch the phone's language (English or Español — the learner also picks
  this on the very first screen),
...
js/lessons.es.js      Spanish lesson text (usted form), keyed by lesson id
